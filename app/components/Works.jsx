    ...
    return (
        <motion.div
            ...
            className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
               I'm Full Stack Developer, I have developed multiple projects using Django, 
               React, and PostgreSQL, including web platforms, backend systems, and AI-integrated solutions.
                I focus on building secure, efficient, and user-friendly applications that leverage modern
                 technologies and machine learning. Some of my key projects include:
            </motion.p>
         ...
         ${isDarkMode ? 'dark:hover:bg-darkHover text-white border-white' : 'hover:bg-lightHover text-black'} duration-500 `}>
